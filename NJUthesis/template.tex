...
\begin{englishabstract}
    ...
    are affected by their long-term behaviors、mid-term behaviors and immediate behaviors at the same time, but there is few work handling the time-related features
    of users' behaviors comprehensively. Therefore, we propose a music recommender method based on multidimensional time series analysis in the thesis to enhance recommender
    ...
    of our methods. The contributions of the thesis are as follow:
