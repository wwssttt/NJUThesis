...
\begin{englishabstract}
    ...
    1. A music recommender method based on multidimensional time series analysis was proposed. The method first uses topic models to model a song as a probability 
    ...
    2. A music recommender method based on users' long-term behaviors, mid-term behaviors and immediate behaviors was proposed. The method can dynamically adjust 
    ...
    3. A music recommender system prototype based on the above methods was implemented. In order to improve the efficiency, we use Storm, a distributed realtime 
